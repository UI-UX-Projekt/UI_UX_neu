 ...
 */
public class TopSectionDetailsView extends View {
    ...
    public TopSectionDetailsView(Context context) {
        super(context);
        init(null, 0);
    }

    public TopSectionDetailsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public TopSectionDetailsView(Context context, AttributeSet attrs, int defStyle) {
